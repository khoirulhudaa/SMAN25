...
//         </div>
//         <div>
//           <label className="text-xs" style={{ color: 'black' }}>Kategori</label>
//           <select value={kategori} onChange={e => setKategori(e.target.value)} className="mt-1 w-full rounded-xl px-3 py-2 text-sm" style={{ background: `rgba(255,255,255,0.05)`, border: `1px solid black`, color: theme.surfaceText }}>
...
//       <div className="rounded-2xl overflow-hidden" style={{ border: `1px solid black` }}>
...
//   if (loading) return <div className="text-center py-8" style={{ color: 'black' }}>Memuat profil...</div>;
//   if (error) return <div className="text-center py-8" style={{ color: theme.pop }}>Gagal memuat profil</div>;
//   if (!profile) return <div className="text-center py-8" style={{ color: 'black' }}>Profil belum tersedia</div>;
...
//           <div className="text-sm opacity-80" style={{ color: 'black' }}>Rata-rata</div>
...
//               <div>
//                 <div className="text-sm opacity-75" style={{ color: 'black' }}>Rata-rata</div>
...
//                   <span className="w-8" style={{ color: 'black' }}>{n} stars</span>
...
//                   </div>
//                   <span className="w-6 text-right" style={{ color: 'black' }}>{ratingSummary.stats[`rating_${n}`] || 0}</span>
//                 </div>
//               ))}
//             </div>
//             <div className="text-xs opacity-75" style={{ color: 'black' }}>Total: {ratingSummary.total_ratings}</div>
//           </motion.div>
//         )}
//       </div>
...
//             </h1>
//             <p className="mt-3" style={{ color: 'black' }}>Informasi publik terbuka untuk semua.</p>
...
//             <div className="rounded-2xl p-4" style={{ background: `rgba(255,255,255,0.05)`, border: `1px solid black` }}>
//               <ul className="space-y-2 text-sm">
//                 <li className="flex gap-2 items-center" style={{ color: 'black' }}><Info/> <b>NPSN:</b> {school.npsn}</li>
//                 <li className="flex gap-2 items-center" style={{ color: 'black' }}><Clock/> <b>Jam:</b> {school.hours}</li>
//                 <li className="flex gap-2 items-center" style={{ color: 'black' }}><MessageCircle/> <b>Email:</b> {school.email}</li>
//               </ul>
//             </div>
//           </div>
//         </div>
...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-[78vh] flex items-center justify-center z-[1] overflow-hidden">
      {/* Background Image - Representatif transparansi / PPID */}
      <div
        className="absolute inset-0 bg-cover bg-center bg-no-repeat"
        style={{
          backgroundImage: `url('/hero2.png')`, // Ganti dengan foto gedung sekolah atau simbol transparansi jika ada
...
/****************************
 * MAIN COMPONENT DENGAN HERO BARU
 ****************************/
let theme: any = {};
export function PPIDMain() {
  const school = SMAN25_CONFIG;
  ...
  return (
    <div className="min-h-screen" style={{ background: theme.bg }}>
      ...
      <motion.div
        ...
        style={{ background: theme.surface, borderColor: theme.border }}
      >
        <div className="max-w-7xl mx-auto px-4 py-10 sm:py-14 grid sm:grid-cols-2 gap-6 items-center">
          <div>
            <div className="inline-flex items-center gap-2 text-xs font-semibold px-3 py-1 rounded-full mb-3" style={{ background: theme.gold, color: '#1b1b1b' }}>
              <IShield/> Transparansi
            </div>
