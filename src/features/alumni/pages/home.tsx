    ...
    >
      ...
      <div className="relative overflow-hidden rounded-2xl border" style={cardStyle}>
        ...
        <div className="absolute left-4 right-4 top-4 text-left">
          <h3 className="m-0 text-lg font-semibold" style={{ color: theme.primaryText, textShadow: '0 2px 6px rgba(0,0,0,0.7)' }}>
            {name}
          </h3>
        ...
        {showUserInfo && (
          <div className="absolute left-4 right-4 bottom-4 flex justify-between items-end gap-2">
            <div>
              <div className="text-[12px]" style={{ color: theme.primaryText }}>
                @{handle} • {angkatan && `Angkatan ${angkatan}`} {jurusan && `· ${jurusan}`}
              </div>
              <div className="mt-1 text-[11px] space-y-0.5" style={{ color: theme.primaryText }}>
                {jenjang && (
  ...
  return (
    <div className="min-h-screen" style={{ background: theme.bg }}>
      ...
      <main className="mx-auto max-w-7xl px-4 py-10">
        ...
        >
          <div>
            <h1 className="text-2xl sm:text-3xl font-semibold" style={{ color: theme.primaryText }}>
        ...
        <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} className="mt-6 flex gap-3">
          <input
            ...
            style={{ color: theme.primaryText, borderColor: theme.border }}
            disabled={loading}
          />
          <button
              ...
              >
                <div className="relative rounded-3xl p-4" style={{ background: theme.surface, border: `1px solid ${theme.border}` }}>
                  <button
                    ...
                    style={{ background: 'rgba(255,255,255,0.08)', border: `1px solid ${theme.border}`, color: theme.primaryText }}
                  >
                    Tutup
                  </button>
                  <InlineProfileCard
            ...
            >
              ...
              >
                <div
                  ...
                  style={{ background: theme.surface, border: `1px solid ${theme.border}` }}
                >
                  <h2 className="text-xl font-semibold mb-4" style={{ color: theme.primaryText }}>
                    Tambah Alumni Baru
                  </h2>

                  <form onSubmit={handleSubmit(onCreateAlumni)} className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm mb-1" style={{ color: theme.primaryText }}>Nama Lengkap</label>
                      <input {...register("nama")} className="w-full rounded-lg px-3 py-2" style={{ background: "rgba(255,255,255,0.06)", border: `1px solid ${theme.border}`, color: theme.primaryText }} placeholder="Budi Alumni Sukses" />
                      {errors.nama && <p className="text-xs mt-1" style={{ color: theme.pop }}>{errors.nama.message}</p>}
                    </div>

                    <div>
                      <label className="block text-sm mb-1" style={{ color: theme.primaryText }}>Email</label>
                      <input {...register("email")} type="email" className="w-full rounded-lg px-3 py-2" style={{ background: "rgba(255,255,255,0.06)", border: `1px solid ${theme.border}`, color: theme.primaryText }} placeholder="budi@example.com" />
                      {errors.email && <p className="text-xs mt-1" style={{ color: theme.pop }}>{errors.email.message}</p>}
                    </div>

                    <div>
                      <label className="block text-sm mb-1" style={{ color: theme.primaryText }}>Kontak (WA)</label>
                      <input {...register("kontak")} className="w-full rounded-lg px-3 py-2" style={{ background: "rgba(255,255,255,0.06)", border: `1px solid ${theme.border}`, color: theme.primaryText }} placeholder="081234567891" />
                      {errors.kontak && <p className="text-xs mt-1" style={{ color: theme.pop }}>{errors.kontak.message}</p>}
                    </div>

                    <div>
                      <label className="block text-sm mb-1" style={{ color: theme.primaryText }}>Tahun Kelulusan</label>
                      <input {...register("tahunKelulusan")} placeholder="2020/2021" className="w-full rounded-lg px-3 py-2" style={{ background: "rgba(255,255,255,0.06)", border: `1px solid ${theme.border}`, color: theme.primaryText }} />
                      {errors.tahunKelulusan && <p className="text-xs mt-1" style={{ color: theme.pop }}>{errors.tahunKelulusan.message}</p>}
                    </div>

                    <div>
                      <label className="block text-sm mb-1" style={{ color: theme.primaryText }}>Jenjang Asal</label>
                      <select {...register("jenjangAsal")} className="w-full rounded-lg px-3 py-2" style={{ background: "rgba(255,255,255,0.06)", border: `1px solid ${theme.border}`, color: theme.primaryText }}>
                    ...
                    <div>
                      <label className="block text-sm mb-1" style={{ color: theme.primaryText }}>Institusi Tujuan</label>
                      <input {...register("institusiTujuan")} className="w-full rounded-lg px-3 py-2" style={{ background: "rgba(255,255,255,0.06)", border: `1px solid ${theme.border}`, color: theme.primaryText }} placeholder="Universitas XYZ" />
                      {errors.institusiTujuan && <p className="text-xs mt-1" style={{ color: theme.pop }}>{errors.institusiTujuan.message}</p>}
                    </div>

                    <div>
                      <label className="block text-sm mb-1" style={{ color: theme.primaryText }}>Program Studi</label>
                      <input {...register("programStudi")} className="w-full rounded-lg px-3 py-2" style={{ background: "rgba(255,255,255,0.06)", border: `1px solid ${theme.border}`, color: theme.primaryText }} placeholder="Teknik Informatika" />
                      {errors.programStudi && <p className="text-xs mt-1" style={{ color: theme.pop }}>{errors.programStudi.message}</p>}
                    </div>

                    <div>
                      <label className="block text-sm mb-1" style={{ color: theme.primaryText }}>Jenis Institusi</label>
                      <select {...register("jenisInstitusi")} className="w-full rounded-lg px-3 py-2" style={{ background: "rgba(255,255,255,0.06)", border: `1px solid ${theme.border}`, color: theme.primaryText }}>
                    ...
                    <div className="flex justify-end w-full ml-auto gap-3 mt-6">
                      <button type="button" onClick={() => setShowCreateModal(false)} className="px-4 py-2 rounded-lg" style={{ background: "rgba(255,255,255,0.08)", border: `1px solid ${theme.border}`, color: theme.primaryText }}>
                        Batal
                      </button>
