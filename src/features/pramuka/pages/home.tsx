...
function StyleInjector({ theme }: { theme: any }) {
  useEffect(() => {
    ...
    style.innerHTML = `
      .btn-yellow{ background:${theme.accent}; color:#000; border:1px solid ${theme.border}; border-radius:0.75rem; padding:0.5rem 0.75rem; display:inline-flex; align-items:center; gap:6px; font-weight:500; }
      ...
      .chip-on{ background:${theme.accent}; color:#000; }
    `;
  ...
  return (
    <div className="min-h-screen" style={{ background: theme.bg }}>
      ...
      <main
        ...
        style={{
          background: `radial-gradient(1000px 600px at 10% -10%, ${theme.accent}22, transparent)`,
        }}
      >
