...
const GalleryComp = () => {
  ...
  return (
    <div className="min-h-max" style={{ background: 'white' }}>
      <section id="galeri-content" className="py-12 md:py-16 -mt-12 relative z-[1]">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          ...
          {loading ? (
            ...
            <div className="w-full mx-auto md:flex items-center justify-center flex-wrap gap-8">
              {albums.map((album) => (
                <motion.div
                  key={album.id}
                  className="group w-full md:w-[30%] relative border border-gray-300 md:mb-0 mb-5 rounded-2xl overflow-hidden shadow-2xl cursor-pointer bg-black/40"
