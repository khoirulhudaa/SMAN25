...
// import { getXHostHeader } from "@/core/utils/XHostHeader"; // ← dihapus karena tidak dipakai lagi
...
const OsisPage = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch('https://be-school.kiraproject.id/osis?schoolId=88', {  // Ganti schoolId sesuai kebutuhan
        cache: 'no-store',
        headers: {
